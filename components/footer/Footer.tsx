...
const Footer = ({ footer }: {
  ...
  return (
      <footer className="footer   p-10 bg-blue-500 text-base-content">
          <div>
              ...
              <p>{footer.copyright}</p>
               <p>{footer.developed_by}</p>
          </div>
          <div>
              <span className="footer-title">{footer.Services}</span>
          ...
          <div>
              <span className="footer-title">{footer.Company}</span>
